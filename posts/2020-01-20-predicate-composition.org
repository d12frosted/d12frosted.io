...
Wow, this is kind of tricky. The =getAll . coerce= expression literally says --
'give me something representationally equal to =Bool= and I will get to back the
=Bool='. It will do all the conversion for us.
...
the runtime. After all, as developers we want to simplify our /development/ life
...
I love the [[https://willamette.edu/~fruehr/haskell/evolution.html][The Evolution of a Haskell Programmer]] by Fritz Ruehr. And to keep the
traction of this evolution path, we should step back and reflect on atrocious
results. We all love functions, don't we? And functions are known functors and
applicatives. So instead of going this lengthy path, we could just do something
dead simple.
