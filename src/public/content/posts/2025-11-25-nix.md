...
I tried writing my own packages a few times. It was **super** complex. Maybe I'm just a bad citizen of the Nix ecosystem - I never really learned the language extensively, only the basics, because frankly I didn't feel like learning it. But I don't think it's reasonable for a package manager to require users to learn a whole new language just to edit configuration files.
...
I'm not an idealist. I respect that there are idealistic zealots out there building amazing things like Nix. The engineering behind it is fascinating, and the vision is compelling.
