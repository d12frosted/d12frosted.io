            ...
            if (lang === 'related_posts' && isBlogPostContext(context)) {
              ...
              return (
                <div className="border-mp-blue bg-code-bg my-12 border-l-4 p-8 lg:my-16">
                  ...
                  <div className="related-posts-list prose prose-stone dark:prose-invert [&_a]:text-mp-blue [&_a]:decoration-mp-blue/30 [&_a:hover]:text-ink dark:[&_a:hover]:text-white [&_a:hover]:decoration-ink/50 dark:[&_a:hover]:decoration-white/50 max-w-none [&_a]:font-normal [&_a]:underline [&_a]:underline-offset-2 [&_a]:transition-colors">
